...
export const createBooking = async (req, res) => {
    ...
    const { doctorId, userId, appointmentDate, time, reason, patientName, phoneNumber } = req.body;
    ...
    try {
        ...
        const populatedBooking = await Booking.findById(booking._id)
            .populate('doctor', 'name photo qualifications');  // Populate relevant fields from the doctor model

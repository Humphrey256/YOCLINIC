...
import './login.css';
import Header from './header'; // Import Header from header.j
...
function Login() {
  ...
  const handleRegisterClick = () => {
    navigate('/registration'); // Navigate to registartion page
  };
    ...
    <div className="flex flex-col items-center justify-center min-h-screen">
      ...
      <div className="form-container">
        ...
        <div className="text-center mt-4">
          <span>Don't have an account? <a href="/registration" className="text-blue-600">Register</a></span>
        </div>
      </div>
    </div>
  );

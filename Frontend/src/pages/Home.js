...
const Home = () => {
    ...
    return (
        <>
            {/* Hero section */}
            <section className='hero__section pt-[60px] 2xl:h-[800px] bg-cover bg-center' style={{ backgroundImage: `url(${featureImg})` }}>
            ...
            <section className="py-16">
                <div className="container">
                    <div className='lg:w-[470px] mx-auto'>
                        ...
                        <p className='text__para text-center'>Our health System Offers Unmatched, Expert Health Care.</p>
                    </div>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]'>
                        <div className='py-[30px] px-5 bg-white rounded-lg shadow-md'>
                            ...
                            <div className='mt-[30px] text-center'>
                                ...
                                <p className='text-[16px] leading-7 text-textColor font-[400] mt-4'>
                                    Our Health System Offers Unmatched, Expert Health Care. From The Lab To The Clinic.
                                </p>
                                <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center group hover:bg-primaryColor hover:border-none justify-center'>
                        ...
                        <div className='py-[30px] px-5 bg-white rounded-lg shadow-md'>
                            ...
                            <div className='mt-[30px] text-center'>
                                ...
                                <Link to='/locations' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center group hover:bg-primaryColor hover:border-none justify-center'>
                                    <BsArrowRight className='group-hover:text-white w-6 h-5' />
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className='py-[30px] px-5 bg-white rounded-lg shadow-md'>
                            ...
                            <div className='mt-[30px] text-center'>
                                ...
                                <Link to='/appointment' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center group hover:bg-primaryColor hover:border-none justify-center'>
                                    <BsArrowRight className='group-hover:text-white w-6 h-5' />
                                </Link>
                            </div>
                        </div>
                    ...
                    <div className="flex items-center justify-between flex-col lg:flex-row">
                        <div className='xl:w-[670px]'>
                            ...
                            <ul className="pl-4">
                                ...
                                <li className="text__para">
                                    3. View Our Physicians Accepting New Patients, Select an Appointment Time.
                                </li>
                            </ul>
                            <Link to='/'>
                        ...
                        <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
                            ...
                            <div className='absolute top-[40%] left-[30%]'></div>
                        </div>
                    </div>
                </div>
            </section>

...
function Header() {
  ...
  return (
    <header className="bg-blue-900 text-white p-8 flex justify-between items-center">
  <div className="flex items-center space-x-2 flex-row justify-start">
  <img src="./Yoclinic/logo.WEBP" alt="YOCLINIC Logo" className="w-10 h-10" />
  <div className="text-2xl font-bold">YOCLINIC</div>
</div>
      <div className="menu-icon md:hidden" style={{ position: 'absolute', right: '0' }} onClick={() => setMenuOpen(!menuOpen)}>
